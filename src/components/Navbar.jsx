...
const Navbar = () => {
 const [isMobileMenuOpen, setMobileMenuOpen] = useState(false);
  ...
  const toggleMobileMenu = () => {
    ...
    return (
        <>
      <nav className='bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-4'>
  ...
  {isMobileMenuOpen && (
        <div id="mobileMenu" className="lg:hidden bg-black p-2 text-center font-bold text-3xl w-full h-full absolute">
